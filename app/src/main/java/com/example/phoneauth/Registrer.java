...
public class Registrer extends AppCompatActivity {
    FirebaseAuth fAuth;
    String phoneNumber = "+916388955315";
    String otpCode = "159515";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registrer_page);
    ...
    private void requestPhoneAuth(String phoneNumber) {
        PhoneAuthProvider.getInstance().verifyPhoneNumber(phoneNumber,60L, TimeUnit.SECONDS,this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
            ...
            public void onCodeAutoRetrievalTimeOut(String s) {
                ...
                Toast.makeText(Registrer.this, "OTP Timeout, Please Re-generate the OTP Again.", Toast.LENGTH_SHORT).show();
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                  checkUserProfile();
                    ...
                    progressBar.setVisibility(View.GONE);
                    state.setVisibility(View.GONE);
                    Toast.makeText(Registrer.this, "Can not Verify phone and Create Account.", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void checkUserProfile() {
        ...
        docRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Registrer.this, "Profile Do Not Exists", Toast.LENGTH_SHORT).show();
